...
<div class="main-content">
    <div class="widget">
            ...
            <div class="padded">
                <table class="table table-striped table-bordered table-hover datatable">
                    ...
                    <tr>
                        ...
                        <td>${user.password}</td>
                        <td>${user.email}</td>
                        <td><c:forEach var="role" items="${user.tblroleusersById}">${role.tblroleByRole.role}</c:forEach></td>
                        <td class="text-right">${fn:length(user.taskWorker)}</td>
                        <td class="text-right">
        ...
        <a href="/user/insert" class="btn btn-primary btn-round btn-lg" style="margin-top: 10px"><i class="icon-plus-sign"></i> Add User</a>
    </div>
</div>
</div>
</div>
